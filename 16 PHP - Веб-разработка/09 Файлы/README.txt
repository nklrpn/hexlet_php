...
<input class="file" type="file" name="car[pictures][]">
После загрузки на сервер (обработчик POST /cars) происходит проверка на ошибки и готовится массив, 
содержащий список загруженных файлов:
...
Она включает в себя формирование массива ошибок $errors (при условии что они были), 
а так же формирование массива $pictures, 
который уже будет использоваться для сохранения загруженных картинок.